...
\raggedright{A manufacturer makes two types of toys A and B.Three machines are needed for this purpose and the time(in minutes)required for each toy on the machines is given below:}\\
\centering
\vspace{0.25cm}
...
\vspace{0.4cm}\\
\raggedright
Each machine is available for a maximum 6 hours per day. If the profit on each toy of type A is Rs.7.50 and that on eahc toy of type B is Rs.5, show that 15 toys of type A and 30 type B should be manufactured in a day to get maximum profit
\section{Solution}
...
\centering
\vspace{0.25cm}
$ Z = \max\limits_{x,y} \myvec{7.50&5} \vec{x}$\\
\vspace{0.25cm}
$\myvec{2&1\\3&0\\2&3}x \leq \myvec{1\\1\\2}$\\
\vspace{0.25cm}
$ \vec{x} \geq 0 $\\
\vspace{0.25cm}
