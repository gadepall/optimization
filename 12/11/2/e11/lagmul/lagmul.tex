...
\end{align}
\fi
As there are no constraints on $\bm{\lambda}$, using Lagrange multipliers,
\begin{align}
...
\label{eq:12/11/2/e11/lagmul6}
\end{align}
Solving \eqref{eq:12/11/2/e11/lagmul6} we get
\begin{align}
