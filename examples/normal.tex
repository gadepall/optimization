...
\input{12/6/5/27/nonconv/grad/grad.tex}
\item Convex Constraint
	\\
\label{12/6/5/27/conv/grad}
\input{12/6/5/27/conv/grad/grad.tex}
...
\input{12/6/5/27/conv/sdp/semi.tex}
%	We	
...
\item  Find the equation of the normal to the curve $x^2=4y$ which passes through the point (4,-2)
		...
		\begin{enumerate}
			\item Quadratic Progamming
\input{12/6/6/4/conv/conv.tex}
	\item  Gradient Descent
		\\
\input{12/6/6/4/grad/grad.tex}
\item Semi-definite Programming
\input{12/6/6/4/sdp/sdp.tex}
\item  Lagrange Multipliers
\input{12/6/6/4/lagmul/lagmul.tex}
		\end{enumerate}
%
\item
\label{12/6/6/22}
